...
class SettingsController:
    ...
    def add_node(self):
        ...
        self.view.notification_label.setText(TS.settings_controller[0]) # Unsaved changes detected; Node added.
    ...
    def move_up(self):
        ...
        if current_index > 0:
            ...
            self.view.notification_label.setText(TS.settings_controller[1]) # Unsaved changes detected; List order has changed.
    ...
    def remove_node(self):
        ...
        if node:
            ...
            self.view.notification_label.setText(TS.settings_controller[2]) # Unsaved changes detected; Node removed.
    ...
    def save_nodes_to_config(self, nodes):
        ...
        if nodes:
            ...
            # Update status
            self.view.notification_label.setText(TS.settings_controller[3]) # Settings successfully saved!
            return True
        else:
            self.view.notification_label.setText(TS.settings_controller[4]) # Can't save empty list
            return False

    def restore_defaults(self):
        self.initialize_node_list(nodes=self.config.node_list)
        self.view.notification_label.setText(TS.settings_controller[5]) # Restored default nodes. Remember to save changes!
